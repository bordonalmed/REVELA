...
export function OpenGraphHead() {
  useEffect(() => {
    ...
    addMetaTag('og:url', 'https://www.revela.fun');
    addMetaTag('og:site_name', 'Revela');
    
    // Open Graph Image (com URL absoluta)
    addMetaTag('og:image', 'https://www.revela.fun/revela3-transparent-processed.png');
    addMetaTag('og:image:secure_url', 'https://www.revela.fun/revela3-transparent-processed.png');
    ...
    addMetaTag('twitter:image', 'https://www.revela.fun/revela3-transparent-processed.png');
